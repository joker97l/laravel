...
<div class="container">
  <div class="row">
    <div class="col-sm-3">
      <div class="jumbotron">
        <p> <span class="label label-info">Категорий {{$count_categories}}</span> </p>
      </div>
    </div>
    <div class="col-sm-3">
      <div class="jumbotron">
        <p> <span class="label label-info">Материалов {{$count_articles}}</span> </p>
      </div>
    </div>
    <div class="col-sm-3">
      <div class="jumbotron">
        <p> <span class="label label-info">Посетителей 0</span> </p>
      </div>
    </div>
    <div class="col-sm-3">
      <div class="jumbotron">
        <p> <span class="label label-info">Сегодня 0</span> </p>
      </div>
    </div>
  </div>
  <div class="row">
